...
const newsArticles: NewsArticle[] = [
  {
    ...
    excerpt: 'AC Newport launched as a new initiative to elevate football in Newport and surrounding Aquidneck Island, bringing competitive soccer to this renowned sporting hub.',
    category: 'Club News'
  },
  {
    id: 2,
